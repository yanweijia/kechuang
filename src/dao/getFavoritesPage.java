 ...
 */
@WebServlet("/getFavoritesPage")
public class getFavoritesPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			sql = "SELECT mid,uid,mcontent,mtype,mstate,mtime,mattach FROM msg_info WHERE mid in(SELECT mid FROM favoritelist WHERE uid=" + uid + ")";
